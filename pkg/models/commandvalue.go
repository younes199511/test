...
func NewBoolValue(DeviceResourceName string, origin int64, value bool, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Bool, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewBoolArrayValue creates a CommandValue of Type BoolArray with the given value.
func NewBoolArrayValue(DeviceResourceName string, origin int64, value []bool, quality int64) (cv *CommandValue, err error) {
...
func NewStringValue(DeviceResourceName string, origin int64, value string, quality int64) (cv *CommandValue) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: String, stringValue: value, quality: quality}
	return
}

// NewUint8Value creates a CommandValue of Type Uint8 with the given value.
func NewUint8Value(DeviceResourceName string, origin int64, value uint8, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Uint8, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewUint8ArrayValue creates a CommandValue of Type Uint8Array with the given value.
func NewUint8ArrayValue(DeviceResourceName string, origin int64, value []uint8, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewUint16Value(DeviceResourceName string, origin int64, value uint16, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Uint16, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewUint16ArrayValue creates a CommandValue of Type Uint16Array with the given value.
func NewUint16ArrayValue(DeviceResourceName string, origin int64, value []uint16, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewUint32Value(DeviceResourceName string, origin int64, value uint32, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Uint32, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewUint32ArrayValue creates a CommandValue of Type Uint32Array with the given value.
func NewUint32ArrayValue(DeviceResourceName string, origin int64, value []uint32, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewUint64Value(DeviceResourceName string, origin int64, value uint64, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Uint64, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewUint64ArrayValue creates a CommandValue of Type Uint64Array with the given value.
func NewUint64ArrayValue(DeviceResourceName string, origin int64, value []uint64, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewInt8Value(DeviceResourceName string, origin int64, value int8, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Int8, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewInt8ArrayValue creates a CommandValue of Type Int8Array with the given value.
func NewInt8ArrayValue(DeviceResourceName string, origin int64, value []int8, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewInt16Value(DeviceResourceName string, origin int64, value int16, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Int16, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewInt16ArrayValue creates a CommandValue of Type Int16Array with the given value.
func NewInt16ArrayValue(DeviceResourceName string, origin int64, value []int16, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewInt32Value(DeviceResourceName string, origin int64, value int32, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Int32, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewInt32ArrayValue creates a CommandValue of Type Int32Array with the given value.
func NewInt32ArrayValue(DeviceResourceName string, origin int64, value []int32, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewInt64Value(DeviceResourceName string, origin int64, value int64, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Int64, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewInt64ArrayValue creates a CommandValue of Type Int64Array with the given value.
func NewInt64ArrayValue(DeviceResourceName string, origin int64, value []int64, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewFloat32Value(DeviceResourceName string, origin int64, value float32, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Float32, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewFloat32ArrayValue creates a CommandValue of Type Float32Array with the given value.
func NewFloat32ArrayValue(DeviceResourceName string, origin int64, value []float32, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewFloat64Value(DeviceResourceName string, origin int64, value float64, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Float64, quality: quality}
	err = encodeValue(cv, value)
	return
}

// NewFloat64ArrayValue creates a CommandValue of Type Float64Array with the given value.
func NewFloat64ArrayValue(DeviceResourceName string, origin int64, value []float64, quality int64) (cv *CommandValue, err error) {
	jsonValue, err := json.Marshal(value)
	cv = &CommandValue{
		DeviceResourceName: DeviceResourceName,
		Origin:             origin,
...
func NewCommandValue(DeviceResourceName string, origin int64, value interface{}, t ValueType, quality int64) (cv *CommandValue, err error) {
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: t, quality: quality}
	switch t {
	case Binary:
		// assign cv.BinValue
...
func NewBinaryValue(DeviceResourceName string, origin int64, value []byte, quality int64) (cv *CommandValue, err error) {
	...
	cv = &CommandValue{DeviceResourceName: DeviceResourceName, Origin: origin, Type: Binary, BinValue: value, quality: quality}
	return
}
