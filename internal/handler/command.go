...
func cvsToEvent(device *contract.Device, cvs []*dsModels.CommandValue, cmd string) (*dsModels.Event, common.AppError) {
	...
	for _, cv := range cvs {
		...
		if err != nil {
			...
			cv = dsModels.NewStringValue(cv.DeviceResourceName, cv.Origin, fmt.Sprintf("Assertion failed for device resource, with value: %s and assertion: %s", cv.String(), dr.Properties.Value.Assertion),5)
		}
...
func createCommandValueFromDR(dr *contract.DeviceResource, v string) (*dsModels.CommandValue, error) {
	...
	case "bool":
		...
		result, err = dsModels.NewBoolValue(dr.Name, origin, value,7)
	case "boolarray":
		var arr []bool
		...
		result, err = dsModels.NewBoolArrayValue(dr.Name, origin, arr, 5)
	case "string":
		result = dsModels.NewStringValue(dr.Name, origin, v, 9)
	case "uint8":
		n, err := strconv.ParseUint(v, 10, 8)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewUint8Value(dr.Name, origin, uint8(n), 7)
	case "uint8array":
		var arr []uint8
		...
		result, err = dsModels.NewUint8ArrayValue(dr.Name, origin, arr, 7)
	case "uint16":
		n, err := strconv.ParseUint(v, 10, 16)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewUint16Value(dr.Name, origin, uint16(n), 5)
	case "uint16array":
		var arr []uint16
		strArr := strings.Split(strings.Trim(v, "[]"), ",")
		for _, u := range strArr {
		...
		result, err = dsModels.NewUint16ArrayValue(dr.Name, origin, arr, 8)
	case "uint32":
		n, err := strconv.ParseUint(v, 10, 32)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewUint32Value(dr.Name, origin, uint32(n), 7)
	case "uint32array":
		var arr []uint32
		strArr := strings.Split(strings.Trim(v, "[]"), ",")
		for _, u := range strArr {
		...
		result, err = dsModels.NewUint32ArrayValue(dr.Name, origin, arr, 7)
	case "uint64":
		n, err := strconv.ParseUint(v, 10, 64)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewUint64Value(dr.Name, origin, n, 7)
	case "uint64array":
		var arr []uint64
		strArr := strings.Split(strings.Trim(v, "[]"), ",")
		for _, u := range strArr {
		...
		result, err = dsModels.NewUint64ArrayValue(dr.Name, origin, arr, 5)
	case "int8":
		n, err := strconv.ParseInt(v, 10, 8)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewInt8Value(dr.Name, origin, int8(n), 5)
	case "int8array":
		var arr []int8
		err = json.Unmarshal([]byte(v), &arr)
		if err != nil {
		...
		result, err = dsModels.NewInt8ArrayValue(dr.Name, origin, arr, 5)
	case "int16":
		n, err := strconv.ParseInt(v, 10, 16)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewInt16Value(dr.Name, origin, int16(n),5)
	case "int16array":
		var arr []int16
		err = json.Unmarshal([]byte(v), &arr)
		if err != nil {
		...
		result, err = dsModels.NewInt16ArrayValue(dr.Name, origin, arr, 4)
	case "int32":
		n, err := strconv.ParseInt(v, 10, 32)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewInt32Value(dr.Name, origin, int32(n), 3)
	case "int32array":
		var arr []int32
		err = json.Unmarshal([]byte(v), &arr)
		if err != nil {
		...
		result, err = dsModels.NewInt32ArrayValue(dr.Name, origin, arr, 2)
	case "int64":
		n, err := strconv.ParseInt(v, 10, 64)
		if err != nil {
			return result, err
		}
		result, err = dsModels.NewInt64Value(dr.Name, origin, n, 5)
	case "int64array":
		var arr []int64
		err = json.Unmarshal([]byte(v), &arr)
		if err != nil {
		...
		result, err = dsModels.NewInt64ArrayValue(dr.Name, origin, arr, 5)
	case "float32":
		n, e := strconv.ParseFloat(v, 32)
		if e == nil {
			result, err = dsModels.NewFloat32Value(dr.Name, origin, float32(n), 5)
			break
		}
		...
		if err == nil {
			...
			if err != nil {
				...
				result, err = dsModels.NewFloat32Value(dr.Name, origin, val, 4)
			}
		}
	case "float32array":
		var arr []float32
		...
		result, err = dsModels.NewFloat32ArrayValue(dr.Name, origin, arr, 4)
	case "float64":
		var val float64
		val, err = strconv.ParseFloat(v, 64)
		if err == nil {
			result, err = dsModels.NewFloat64Value(dr.Name, origin, val, 4)
			break
		}
	...
	case "float64array":
		...
		result, err = dsModels.NewFloat64ArrayValue(dr.Name, origin, arr, 4)
	}
